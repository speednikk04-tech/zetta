...
class UpdateUtil(var context: Context) {
    ...
    fun getGithubReleases(): List<GithubRelease> {
        // zetta ships from its own repo. Pointing this at the upstream project would hand the
        // user an original YTDLnis APK on the next "update", silently undoing the rebrand.
        val url = "https://api.github.com/repos/$APP_RELEASES_REPO/releases"
    ...
    companion object {
        ...
        /**
         * GitHub repo that in-app updates are pulled from.
         *
         * The yt-dlp / ffmpeg / python package repos are intentionally left pointing upstream --
         * those are runtime binaries, not the app, and repointing them would break downloads.
         */
        const val APP_RELEASES_REPO = "nikkexe0-del/ytdlpnis-myversion"
    }
}
